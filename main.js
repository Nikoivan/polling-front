...
;// CONCATENATED MODULE: ./src/js/components/Poll.js
...
;// CONCATENATED MODULE: ./src/js/components/State.js
class State {
...
;// CONCATENATED MODULE: ./src/js/components/Polling.js
...
<div class="polling-main">
  ...
  async getMessages() {
    const stream$ = interval(1000).pipe(switchMap(() => ajax({
...
const polling = new Polling(root);
polling.init();
